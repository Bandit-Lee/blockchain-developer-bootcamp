import { ETHER_ADDRESS, ether, tokens, EVM_REVERT } from '../src/helper'
...
// 这个数组在Ganache中的Account中是顺序排列的[deployer, feeAccount, user1]
// 第一个账户是deployer,第二个是feeAccount,第三个是user1
contract('Exchange', ([deployer, feeAccount, user1, user2]) => {
    ...
    describe('order actions', async () => {
        ...
        describe('filling orders', async () => {
            ...
            describe('success', async () => {
                beforeEach(async () => {
                    // user2 fills order, user1 made an order before
